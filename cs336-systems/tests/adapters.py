...
from cs336_systems.kernel import (
    RMSNormFunction, 
...
from cs336_systems.sharding import ShardedOptimizer
...
def rmsnorm_backward_g_pytorch(
    ...
    """
    return compute_grad_g(grad_output, x, g)
...
def rmsnorm_backward_x_pytorch(
    ...
    """
    return compute_grad_x(grad_output, x, g)
